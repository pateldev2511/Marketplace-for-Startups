...
$b_id = $res['b_id'];
 ...
 $sql = "UPDATE `notification_buyers` SET seen='YES' WHERE b_id='$b_id'";
                 $q = mysqli_query($con,$sql);
        ...
        <center>
            <div id="navbar_container">
                ...
                <ul>
                    ...
                    <li><a href="notification_buyer.php" class="active1">Notifications</a></li>
...
<div id="main_container">
    ...
    $sql = "SELECT * FROM `notification_buyers` WHERE b_id='$b_id' ORDER BY id DESC";
    $q = mysqli_query($con,$sql);
