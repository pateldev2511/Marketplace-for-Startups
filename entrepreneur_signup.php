...
<center><p id="signup_title">Sign Up As An Entrepreneur </p></center>
        <form name="f1" method="post" enctype="multipart/form-data">
            ...
            <table id="form_container">
                ...
                <tr>
                    ...
                    <td id="field_con"><input class="field" name="e_name" id="e_name" type="text" required></td>
    ...
    if($r == 1)
    {
      ...
      $r = mysqli_num_rows($q);  
        ...
        if($r == 1)
        {
           ...
           $sql = "SELECT * FROM $t1 WHERE mobile_no='$mobileno'";
           $q = mysqli_query($con,$sql);
           $r = mysqli_num_rows($q);  
        ...
        <br><div style='text-align: center;'><img src='https://psalmisadora.com/wp-content/uploads/2016/05/thank-you.png' width='150px' height='100px' align='center'></div><br>Click On The Following Button To Verify Your Mail.<br><div style='text-align:center;'><br><a href='http://localhost/MarketplaceForStartups/verify_email_entrepreneur.php?stream=e&email=$email&username=$un&token=$token'><button style='width: 50%;height: 30px;background-color: black;color:white;font-size: 20px;border-radius: 20px;'>Verify My Email </button> </a></disv></font><p align='right'><i>Regards</i></p><p align='right'><b>-ValueMart.</b></p>";
                    ...
                    if(!$mail->send()) {
                        ...
                        $sql = "insert into $t1(name,company_name,address,company_address,date_of_birth,gender,country,state,city,profile_image,bio,username,password,mobile_no,email,isverified,s_q,s_a,token) values('$name','$com_name','$address','$com_address','$dob','$gender','$country','$state','$city','$path','Hi','$un','$pw1','$mobileno','$email','$isverified','$s_q','$s_a','$token')";
                    $q = mysqli_query($con,$sql);
                    if($q)
                    {
