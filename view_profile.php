...
if(empty($e_id))
{
    ...
    $sql = "SELECT * FROM $t1 WHERE e_id='$e_id'";
        ...
        <table id="profile_table_container" cellpadding="20px">
            ...
            ?>
                ...
                <td class="width_setter">
                    <p class="eqi_title" title="Entrepreneur Qualifying Inex"> EQI : </p>
                    <span id="e_eqi">9</span>
                    <span class="slash_eqi">/</span>
                    <span id="total">10</span>

                    <p class='dont_know'>Don't Know What Is EQI ?</p>
                    <p><a href="eqi.php" class="click_here">Click Here To Know More</a></p>
                </td>
            </tr>
            ...
            <tr>
              ...
              <td colspan="3">
                    <fieldset>
                        <legend class="leg_c">Recently Added Products : </legend>
                    <?php
