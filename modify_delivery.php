        ...
        <td colspan='4'>
          <fieldset>
                        ...
                        <table name='personal_detail_container'>
                            <tr>
                                <td>
                                    <label class='sub_labl'>Set New Delivery Date : </label>
                                </td>
                                <td>
                              ...
                              <tr>
                                <td>
                                    <label class='sub_labl'>Reason For Changing Delivery Date : </label>
                                </td>
                                <td>
                                    <textarea name='reason' class='more'>
                                    </textarea>
                             </td>
                             </tr>
                             </table>
...
//--------------
        ...
        <td colspan='4'>
         ...
         <center><button class='common_btn' type='submit' name='modify_btn'><span class='btn_title'>Modify This Order</span></button></a>
...
$reason = $_POST['reason'];
  ...
  //  echo "<script>alert('$o');</script>";
    $sql = "UPDATE `orders` SET delivery_date='$dd' WHERE o_id='$o_id'";
...
$new_date = date('d/m/Y', $old_date_timestamp);   
    ...
    $e_msg = "Hey ! $b_name ,<br>
    There Is A Change In The Delivery Of The Product <b> $p_name </b>.
    <br>
    This Order Is Scheduled To Be Arrived On <b> $new_date </b>.
    <br>
    
    ";
    
    $msg = "Hey ! $b_name ,
    There Is A Change In The Delivery Of The Product  $p_name .
    <br>
    This Order Is Scheduled To Be Arrived On $new_date.";
    ...
    echo "<script>alert('You Have Modified This Order Successfully...!!!');window.location.href='pending_orders.php';</script>";
    }
    }
    else {
        echo "<script>alert('Error In Modifying This Order...!!!');</script>";
    }
